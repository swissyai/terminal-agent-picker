...
NTAP_codex_models=$'gpt-5.6-sol\tGPT-5.6 Sol (frontier capability)\ngpt-5.6-terra\tGPT-5.6 Terra (balanced everyday)\ngpt-5.6-luna\tGPT-5.6 Luna (fast/affordable)\ngpt-5.5\tGPT-5.5 (previous frontier)\ngpt-5.4\tGPT-5.4 (strong everyday)\ngpt-5.4-mini\tGPT-5.4-mini (fast/cost-efficient)\ngpt-5.3-codex-spark\tGPT-5.3 Codex Spark (near-instant, Pro only)'
NTAP_codex_reason=$'low\tLow\nmedium\tMedium\nhigh\tHigh\nxhigh\txHigh\nmax\tMax (gpt-5.6 only)\nultra\tUltra (gpt-5.6 Sol/Terra only)'
...
NTAP_codex_defm=$'gpt-5.6-sol'
NTAP_codex_defr=$'medium'
...
NTAP_opencode_models=$'anthropic/claude-sonnet-5\tClaude Sonnet 5 (strong default)\nanthropic/claude-opus-5\tClaude Opus 5 (best reasoning)\nopenai/gpt-5.6-sol\tGPT-5.6 Sol (OpenAI flagship)\ngoogle/gemini-3.1-pro\tGemini 3.1 Pro\nopenrouter/moonshot/kimi-k2.6\tKimi K2.6 (open-weights via OpenRouter)\nopenrouter/z-ai/glm-5.1\tGLM-5.1 (open-weights via OpenRouter)'
...
NTAP_opencode_defm=$'anthropic/claude-sonnet-5'
...
NTAP_aider_defm=$'claude-sonnet-5'
...
NTAP_cursor_defm=$'claude-opus-5'
NTAP_cursor_defr=$''
...
NTAP_qwen_models=$'qwen3.8-max\tQwen3.8-Max (latest, ModelStudio)\nqwen3.6-plus\tQwen3.6-Plus (previous)\nclaude-sonnet-5\tClaude Sonnet 5 (via compatible API)\ngemini-2.5-pro\tGemini 2.5 Pro (via compatible API)'
NTAP_qwen_perms=$'default\t\tDefault (confirm before actions)\tlow\nyolo\t--yolo\tYOLO (skip all approvals)\thigh'
NTAP_qwen_defm=$'qwen3.8-max'
NTAP_qwen_defr=$''
...
NTAP_kilo_models=$'anthropic/claude-sonnet-5\tClaude Sonnet 5 (recommended)\nanthropic/claude-opus-5\tClaude Opus 5\nopenai/gpt-5.6-sol\tGPT-5.6 Sol'
NTAP_kilo_defm=$'anthropic/claude-sonnet-5'
NTAP_kilo_defr=$''
NTAP_kilo_defp=$''
...
NTAP_gptme_models=$'claude-sonnet-5\tClaude Sonnet 5\ngpt-4o\tGPT-4o\ngemini-2.5-pro\tGemini 2.5 Pro'
...
NTAP_gptme_defm=$'claude-sonnet-5'
NTAP_gptme_defr=$''
...
NTAP_pi_models=$'claude-opus-5\tClaude Opus 5 (top frontier)\nclaude-sonnet-5\tClaude Sonnet 5 (best price/perf)\nopenai/gpt-5.6-sol\tGPT-5.6 Sol\ngoogle/gemini-3.1-pro\tGemini 3.1 Pro\nxai/grok-4\tGrok 4'
...
NTAP_hermes_models=$'claude-opus-5\tClaude Opus 5 (highest ceiling)\nclaude-sonnet-5\tClaude Sonnet 5 (Nous-recommended)\ngpt-5.6-sol\tGPT-5.6 Sol\ngemini-2.5-pro\tGemini 2.5 Pro (1M context)\nkimi-k2-6\tKimi K2.6 (open-weights)\ndeepseek-v4\tDeepSeek V4 (budget)'
...
NTAP_hermes_defm=$'claude-sonnet-5'
NTAP_hermes_defr=$''
...
NTAP_openhands_mini_models=$'claude-sonnet-5\tClaude Sonnet 5\ngpt-4o\tGPT-4o'
...
NTAP_openhands_mini_defm=$'claude-sonnet-5'
